...
function t827_init(recid) {
    ...
    if (typeof jQuery !== "undefined") {
        $(rec)
            .find(".t827")
            .bind("displayChanged", function (e) {
...
function t827_initMasonry(rec, recid, grid, eventType) {
    ...
    var gutterWidth;
    if (gutterElement && (gutterElement.offsetWidth === 40 || window.getComputedStyle(gutterElement).width === "40px")) {
        gutterWidth = 39;
    } else {
    ...
    t_onFuncLoad("imagesLoaded", function () {
        if (eventType === "displayChanged" && grid.getAttribute("data-hidden-tab") === "y") {
            ...
            new Masonry(grid, { columnWidth: "#rec" + recid + " .t827__grid-sizer", itemSelector: "#rec" + recid + " .t827__grid-item", gutter: gutterWidth, isFitWidth: !0, transitionDuration: 0 });
        } else {
            imagesLoaded(grid, function () {
                new Masonry(grid, { columnWidth: "#rec" + recid + " .t827__grid-sizer", itemSelector: "#rec" + recid + " .t827__grid-item", gutter: gutterWidth, isFitWidth: !0, transitionDuration: 0 });
            });
...
function t827_calcColumnWidth(rec, sizerWidth, grid, sizer, items) {
    ...
    var gutterSizerWidth = gutterElement ? gutterElement.offsetWidth || parseInt(window.getComputedStyle(gutterElement).width, 10) : 0;
